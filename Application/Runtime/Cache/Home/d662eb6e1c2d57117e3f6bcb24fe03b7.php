...
<html lang="en">
  <head>
    ...
    <!-- Page Specific CSS -->
    <link rel="stylesheet" href="/yingsen/Public/admin/css/morris-0.4.3.min.css">
  </head>
  ...
  <body>
    ...
    <!-- Page Specific Plugins -->    <script src="/yingsen/Public/admin/js/raphael-min.js"></script>
    <script src="/yingsen/Public/admin/js/morris-0.4.3.min.js"></script>
    <script src="/yingsen/Public/admin/js/morris/chart-data-morris.js"></script>
	...
	<script src="/yingsen/Public/admin/js/flot/jquery.flot.js"></script>
	<script src="/yingsen/Public/admin/js/flot/jquery.flot.tooltip.min.js"></script>
	<script src="/yingsen/Public/admin/js/flot/jquery.flot.resize.js"></script>
	<script src="/yingsen/Public/admin/js/flot/jquery.flot.pie.js"></script>
	<script src="/yingsen/Public/admin/js/flot/chart-data-flot.js"></script>
