...
<script src="/new/Public/fourier/js/responsiveslides.min.js"></script>
 <script>
    $(function () {
  ...
  <!--startsmothscrolling-->
<script type="text/javascript" src="/new/Public/fourier/js/move-top.js"></script>
<script type="text/javascript" src="/new/Public/fourier/js/easing.js"></script>
		...
		<!-- Collect the nav links, forms, and other content for toggling -->
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav">
							...
							<li><a href="<?php echo U('page/contact');?>">留言板</a></li>
						</ul>
				...
				<div class="callbacks_container">
					<ul class="rslides" id="slider">
						 <li>	 
							...
							<img src="/new/Public/fourier/images/p.png"  class="img-responsive" alt="/">
							</div>
							<div class="col-md-6 cap">
								<h3>最时尚的造型 </h3>  
								<p>经过我们的打造，还你一个时尚潮流梦</p>
						 ...
						 <li>
							<div class="caption">
							<div class="col-md-6 cap-img">
								<img src="/new/Public/fourier/images/zongjian5.png"  class="img-responsive" alt="/">
							</div>
							<div class="col-md-6 cap">
								<h3>相信我们，把一切不可能变为可能 </h3> 
								<p>还在因自己工科男女不懂装扮自己而烦恼吗？还在羡慕有男票女票的人儿吗？让我们从发型改变你，让你拥有自信。</p>
								<a class="button" data-toggle="modal" data-target="#myModal1" href="#">order online</a>
							</div>
							</div>
							<div class="clearfix"></div>
						 ...
						 <li>	          
							<div class="caption">
							<div class="col-md-6 cap-img">
							<img src="/new/Public/fourier/images/g4.jpg"  class="img-responsive" alt="/">
							</div>
							<div class="col-md-6 cap">
								<h3>会员优惠多多</h3>
								<p>加入我们的会员，在梦幻造型的变换中，节省资金。</p>
								<a class="button" data-toggle="modal" data-target="#myModal1" href="#">order online</a>
							</div>
							</div>
							<div class="clearfix"></div>
